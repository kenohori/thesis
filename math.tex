...
\refse{se:settheory} introduces the main concepts of set theory and mathematical logic, the branches of mathematics that are thereafter used as a basis for more complex notions.
