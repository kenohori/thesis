...
Perhaps more importantly, these definitions do not reflect modern mathematical thought on the topic\footnote{In short, this intuitive definition of sets pretty much assumes that anything can be put into a set without leading to paradoxes, which is not the case.}, \eg\ axiomatic set theory.
