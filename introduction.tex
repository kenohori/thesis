...
\emph{Rather than guaranteeing the best solution on input fulfilling certain strict conditions, GIS tools are  expected to make a best effort to obtain a good solution on the (often invalid) data that is available}.
