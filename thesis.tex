...
\pretocmd{\maketitle}{%
  ...
  \pdfbookmark[0]{Preliminaries}{title}% TODO: Change link to cover
...
\renewpagestyle{scrheadings}{
  {\thepage\quad\rule{1pt}{100pt}\quad{}Contents}%
  {\hfill\rightmark\quad\rule{1pt}{100pt}\quad\thepage}%
  {}
}{
  {}%
  {}%
...
\renewpagestyle{scrheadings}{
  {\hspace{-\marginparwidth}\hspace{-\marginparsep}\makebox[\overflowingheadlen][l]{\thepage\quad\rule{1pt}{100pt}\quad{}Preface}}%
  {\makebox[\overflowingheadlen][r]{\rightmark\quad\rule{1pt}{100pt}\quad\thepage}}%
  {}
}{
  {}%
  {}%
...
\renewpagestyle{scrheadings}{
  {\hspace{-\marginparwidth}\hspace{-\marginparsep}\makebox[\overflowingheadlen][l]{\thepage\quad\rule{1pt}{100pt}\quad{}\leftmark}}%
  {\makebox[\overflowingheadlen][r]{\rightmark\quad\rule{1pt}{100pt}\quad\thepage}}%
  {}
}{
  {}%
...
% \newgeometry{ignoremp}
% \part{Data processing, conclusions and implementations}
...
\cleardoublepage%
\renewpagestyle{scrheadings}{
  {\thepage\quad\rule{1pt}{100pt}\quad\leftmark}%
  {\hfill\rightmark\quad\rule{1pt}{100pt}\quad\thepage}%
  {}
}{
  {}%
...
% TODO: Reset footnote numbers per chapter
% TODO: Links to footnotes?
% TODO: Check that footnotemarks are in right page
% TODO: Check bibliography
% TODO: Check that figures are in the right order