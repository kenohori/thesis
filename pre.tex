...
The cells of the model were manually defined and embedded in $\mathbb{R}^4$, projected inwards/outwards to the volume of a 3-sphere, stereographically projected to $\mathbb{R}^3$ and exported as an\ {}.obj file.
This 3D model was then imported in Blender and rendered using a perspective projection (\reffig{fig:stereo-earth}) down to 2D.
